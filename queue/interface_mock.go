...
// Source: orders/internal/infra/queue (interfaces: QueueI)
...
func (m *MockQueueI) Consume(arg0 context.Context, arg1 string, arg2 func(context.Context, []byte) error) {
	m.ctrl.T.Helper()
...
func (m *MockQueueI) ConsumeStream(arg0 context.Context, arg1 string, arg2 func(context.Context, []byte) error) {
	m.ctrl.T.Helper()
...
func (m *MockQueueI) Produce(arg0 context.Context, arg1 string, arg2 interface{}) error {
	m.ctrl.T.Helper()
