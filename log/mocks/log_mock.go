...
import (
	...
	log "github.com/braiphub/go-core/log"
...
func (m *MockLoggerI) Debug(arg0 string, arg1 ...log.Field) {
	m.ctrl.T.Helper()
...
func (m *MockLoggerI) Error(arg0 string, arg1 error, arg2 ...log.Field) {
	m.ctrl.T.Helper()
...
func (m *MockLoggerI) Fatal(arg0 string, arg1 ...log.Field) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *MockLoggerI) Info(arg0 string, arg1 ...log.Field) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *MockLoggerI) Trace(arg0 string, arg1 ...log.Field) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *MockLoggerI) Warn(arg0 string, arg1 ...log.Field) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
